...
import { PostResponse } from 'src/app/models/apiResponse';
...
export class FlowerService {
  ...
  public getAll(): Observable<Flower[]> {
    return this.httpClient.get<Flower[]>(
      `${environment.backendUrl}/api/flowers`
    );
  }

  public getById(id: number): Observable<Flower> {
    return this.httpClient.get<Flower>(
      `${environment.backendUrl}/api/flowers/${id}`
    );
  }

  public create(flower: Flower): Observable<PostResponse> {
  ...
  public update(flowerId: number, flower: Flower): Observable<PostResponse> {
    return this.httpClient.post<PostResponse>(
      `${environment.backendUrl}/api/flowers/update/${flowerId}`,
      flower
    );
  }

  public delete(flowerId: number): Observable<PostResponse> {
    return this.httpClient.post<PostResponse>(
      `${environment.backendUrl}/api/flowers/delete/${flowerId}`,
      {}
    );
  }
}
